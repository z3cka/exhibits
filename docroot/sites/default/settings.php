 ...
 * @endcode
 */
$settings['hash_salt'] = 'cgMrWRD2EBkjEYUWWwc3kp5Kpanz0TcARlZ-ueNpwObCJZj-LwoenqlztWWnUa9nWriCoOMsRw';
...
if (file_exists('/var/www/site-php')) {
  require('/var/www/site-php/uclalibraryexhibits/uclalibraryexhibits-settings.inc');
}

// <DDSETTINGS>
// Please don't edit anything between <DDSETTINGS> tags.
// This section is autogenerated by Acquia Dev Desktop.
if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/cld_devcloud_uclalibraryexhibits_dev_default.inc')) {
  require $_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/cld_devcloud_uclalibraryexhibits_dev_default.inc';
}
// </DDSETTINGS>
$databases['default']['default'] = array (
  'database' => 'uclalibraryexhibits_dev',
  'username' => 'drupaluser',
  'password' => '',
  'prefix' => '',
  'host' => '127.0.0.1',
